...
enum {
  ...
  HYUNDAI_ANGLE_MODEL_HYUNDAI_PALISADE_HEV_LX3,  // 11
...
static const AngleSteeringParams *hyundai_get_angle_params(uint8_t model_id) {
  ...
  static const AngleSteeringParams HYUNDAI_ANGLE_MODELS[] = {
    ...
    // [11] HYUNDAI_PALISADE_HEV_LX3 — mass=2110, wb=2.97, sr=14.3
    [HYUNDAI_ANGLE_MODEL_HYUNDAI_PALISADE_HEV_LX3] = {
      .slip_factor = -0.0005647414746328947,
      .steer_ratio = 14.3,
      .wheelbase = 2.97,
    },
  };
